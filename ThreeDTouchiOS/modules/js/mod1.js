...
function myOnPeekCallback(widget,contextInfo){
  ...
  var previewInfoTable = {"peekForm": frmDetailedMail, "focusRect": [0,0,200,200],"contentSize": [320, 480]}
  frmDetailedMail.info = {selectedMailIndex: contextInfo.rowIndex};
...
function changeSkinForTheItem(rowInd,newskin,readflagval){
    ...
    var newVal = {lblSubj:selItem.lblSubj,
      				lblLine1:{text:selItem.lblLine1.text,skin:newskin},
...
var myQuickActionItems =  [{"id": "inboxactionid","title": "Inbox","subtitle": "No unread messages","icon": constants.QUICK_ACTION_ICON_TYPE_MAIL,"info": {"feed": "feed to first form"}},
          				   {"id": "composeactionid","title": "Compose","subtitle": "Compose a new mail","icon": constants.QUICK_ACTION_ICON_TYPE_COMPOSE,"info": {"feed": "feed to second form"}}
          				   ];
...
var segdata =  [{
            ...
            "lblLine1": {skin:"sknmailunread",text:"New sign-in from iPhone Did not get a new phone?Someone may have your password. Review the devices that have access to your Google account"},
            "lblDate": "15/03/16",
            "lblDomain": "Google",
            "readflag":false
        }, {
